...
public class ItemColoredPowder extends Item {
	...
	public static ColorObject[] colors = { new ColorObject(211, 211, 211),
			new ColorObject(255, 0, 0), new ColorObject(255, 128, 0),
			new ColorObject(255, 255, 0), new ColorObject(128, 255, 0),
			new ColorObject(0, 153, 0), new ColorObject(0, 255, 0),
			new ColorObject(0, 255, 128), new ColorObject(0, 255, 255),
			new ColorObject(0, 128, 255), new ColorObject(0, 0, 255),
			new ColorObject(128, 0, 255), new ColorObject(255, 0, 255),
			new ColorObject(255, 0, 128), new ColorObject(204, 0, 204),
			new ColorObject(197, 179, 88), new ColorObject(128, 128, 128),
			new ColorObject(102, 51, 153), new ColorObject(255, 153, 153),
			new ColorObject(16, 145, 117) };
	...
	public boolean itemInteractionForEntity(ItemStack stack,
		...
		if (!player.worldObj.isRemote && stack.hasTagCompound()) {
			...
			ColorObject colorObj = ColorObject.getColorFromTag(stack
					.getTagCompound());
	...
	public int getColorFromItemStack(ItemStack stack, int pass) {
		...
		if (pass == 0 && stack.hasTagCompound())
			return ColorObject.getIntFromColor(ColorObject
					.getColorFromTag(stack.stackTagCompound));
