...
public class ColorProperties implements IExtendedEntityProperties {
	...
	public void loadNBTData(NBTTagCompound compound) {
		...
		this.colorObj = ColorObject.getColorFromTag(compound
				.getCompoundTag(PROP_NAME));
		ColorfulMobs.instance.network.sendToAll(new PacketColorSync(colorObj,
				entity));
	}
	...
	public static void setPropsToEntity(EntityLivingBase living) {
		...
		living.registerExtendedProperties(PROP_NAME,
				new ColorProperties(living));
	}
	...
	public static void setEntityColors(ColorObject color,
