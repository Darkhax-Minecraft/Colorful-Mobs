...
public class ItemColoredPowder extends ItemColorSetter {
    ...
    public boolean itemInteractionForEntity (ItemStack stack, EntityPlayer player, EntityLivingBase entity) {
        ...
        if (colorObj.isGenericWhite())
            player.triggerAchievement(ContentHandler.achPureDye);

        else
            player.triggerAchievement(ContentHandler.achDyeMob);
    ...
    public void getSubItems (Item item, CreativeTabs tab, List itemList) {
        ...
        for (EnumVanillaColors color : EnumVanillaColors.values()) {
            ...
            ItemStack powderStack = new ItemStack(ContentHandler.itemPowder, 1);
