...
public class GenericUtilities {
    ...
    /**
     * Returns a random number between the min and max. The min and max are both possible to get.
     * 
    ...
    /**
     * Retrieves an instance of the player from the client side. This code only exists in client side
     * code and can not be used in server side code.
     * 
     * @return
     */
     ...
     * @param isTile: If the item being dropped into the world as a tile this should be set to true. This
     *        option allows for this code to adhere to the doTileDrops game rule.
     */
