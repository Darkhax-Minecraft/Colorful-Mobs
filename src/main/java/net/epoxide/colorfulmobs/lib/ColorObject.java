...
public class ColorObject {
    ...
    /**
     * Creates a new ColorObject using integers which will be converted back into floats. The alpha value
     * is automatically set to 1. (0-255)
     * 
    ...
    /**
     * Creates a new ColorObject using integers which will be converted back into floats. (0-255)
     * 
     * @param red: The amount of red that makes up this color.
     * @param green: The amount of green that makes up this color.
     * @param blue: The amount of blue that makes up this color.
     * @param alpha: The transparency for this color. 0 is fully transparent, while 100 is completely
     *        solid.
     * */
     ...
     * @param alpha: The transparency of this color object. 0 is completely see through, 1 is completely
     *        solid.
     */
     ...
     * 
     * @param tag: An NBTTagCompound which contains a red green blue and alpha tag. If a specific piece
     *        of data is missing, it will be treated as a 0.
     * @return ColorObject: A ColorObject which contains all of the color data from the provided
     *         NBTTagCompound.
     */
    ...
    /**
     * Converts a ColorObject to a decimal color value. This is most notably used by Mojang for item
     * overlay colors.
     * 
    ...
    /**
     * Converts a decimal color integer like the one produced in getIntFromColor back into a ColorObject.
     * 
    ...
    /**
     * A simple method used to check if a ColorObject is generic. A generic ColorObject is considered a
     * ColorObject that represents White.
     * 
    ...
    /**
     * A method which can be used to check if a ColorObject is generic. A Generic ColorObject, as defined
     * in this method, is a ColorObject which has the same value for R, G and B.
     * 
    ...
    /**
     * Creates a copy of the provided ColorObject, useful when you don't want to mess up existing
     * instances.
     * 
    ...
    /**
     * Merges two ColorObject together. The first object represents the primary colors, while the second
     ...
     * @return ColorObject: A new ColorObject which has the RGB of the primary color, and the A of the
     *         alpha color.
     */
