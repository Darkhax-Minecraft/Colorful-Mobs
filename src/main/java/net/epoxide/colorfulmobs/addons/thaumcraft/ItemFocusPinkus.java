...
// }
//
// public List<EntityLivingBase> getEntitiesInView (EntityPlayer player, int range, double
// distance) {
//
...
// AxisAlignedBB.getBoundingBox(targetPos.x - range, targetPos.y - range, targetPos.z - range,
